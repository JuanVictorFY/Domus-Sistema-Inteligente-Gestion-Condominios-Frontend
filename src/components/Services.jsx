...
const Services = () => {
  ...
  return (
    <section id="servicios" className="py-5 position-relative" style={{ background: 'linear-gradient(180deg, #020617 0%, #0a1628 50%, #020617 100%)', overflow: 'hidden' }}>
      {/* Decorative glow */}
      <div className="position-absolute top-50 start-50 translate-middle" style={{ width: '800px', height: '800px', background: 'radial-gradient(circle, rgba(0,86,179,0.06) 0%, transparent 60%)', zIndex: 0 }}></div>
            ...
            <div className="col-lg-4 col-md-6" key={i} data-aos="fade-up" data-aos-delay={i * 150}>
              <div className="service-card-elite h-100 d-flex flex-column text-start">
                ...
                <div className="mt-auto">
                  <button className="btn-know-more" onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })}>
